...
describe 'packages/openbox' do
  ...
  it 'adds the following commands' do
    ...
    AppConf.commands.map(&:info).should == [
      ...
      "SUDO   cp -rf /etc/sudoers /etc/new_sudoers",
      "SUDO   chmod 600 /etc/new_sudoers",
      "SUDO   echo \"ALL   ALL=NOPASSWD:/sbin/shutdown\" >> /etc/new_sudoers",
      "SUDO   echo \"ALL   ALL=NOPASSWD:/sbin/reboot\" >> /etc/new_sudoers",
      "SUDO   chmod 440 /etc/new_sudoers",
      "SUDO   mv -f /etc/new_sudoers /etc/sudoers",
