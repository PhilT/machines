...
describe 'packages/openbox' do
  ...
  it 'adds the following commands' do
    ...
    $conf.commands.map(&:info).must_equal [
      ...
      "UPLOAD misc/udisks.policy to /tmp/org.freedesktop.udisks.policy",
      ...
      "RUN    echo \"alias slide='feh --action \\\"gimp '%f'\\\" --fullscreen --auto-zoom --borderless --slideshow-delay 5 --sort name'\" >> .bash_aliases"
     ]
  end
end
