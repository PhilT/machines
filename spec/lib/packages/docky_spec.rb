...
describe 'packages/docky' do
  ...
  it 'adds the following commands' do
    ...
    AppConf.commands.map(&:info).should == [
      ...
      "RUN    gconftool-2 --set \"/apps/docky-2/Docky/Interface/DockPreferences/Dock1/Launchers\" --type list --list-type=string [\"file:///usr/share/applications/terminator.desktop\",\"file:///usr/share/applications/abiword.desktop\",\"file:///usr/share/applications/gnumeric.desktop\",\"file:///usr/share/applications/firefox.desktop\",\"file:///usr/share/applications/google-chrome.desktop\",\"file:///usr/share/applications/gimp.desktop\",\"file:///usr/share/applications/inkscape.desktop\",\"file:///usr/share/applications/audacious2.desktop\",\"file:///usr/share/applications/gedit.desktop\"]",
      ...
      "RUN    gconftool-2 --set \"/apps/docky-2/Docky/Interface/DockPreferences/Dock1/SortList\" --type list --list-type=string [\"/usr/share/applications/firefox.desktop\",\"/usr/share/applications/google-chrome.desktop\",\"TrashCan\",\"Clock\",\"GMailDockItem#Inbox\",\"WeatherDockItem\",\"/usr/share/applications/terminator.desktop\",\"/usr/share/applications/gedit.desktop\",\"/usr/share/applications/abiword.desktop\",\"/usr/share/applications/gnumeric.desktop\",\"/usr/share/applications/gimp.desktop\",\"/usr/share/applications/inkscape.desktop\",\"/usr/share/applications/audacious2.desktop\"]",
